...
class AnomalyDetectionRunner():
    ...
    def erun(self):
        ...
        # load data
        feas, Sub_idx = format_data(self.data_name)
        ...
        for epoch in range(1, self.iteration+1):
            ...
            reconstruction_errors, reconstruction_loss, emb = update(gcn_model, opt, sess, feas['adj_norm'], feas['adj_label'], feas['features'], placeholders, feas['adj'])
            if epoch % 10 == 0:
        ...
        saveModel.save(sess, 'data/SavedModel/model_subGraph')


        # saver = tf.train.import_meta_graph('./data/test/savedModel/model_PubMed_0.meta') #'./data/test/savedModel/model_3719_5_1.meta'
        # graph = tf.get_default_graph()
        #
        # saver.restore(sess, './data/test/savedModel/model_PubMed_0') # './data/test/savedModel/model_3719_5_1'
        # reconstruction_errors_a, reconstruction_loss, emb, attribute_reconstructions, structure_reconstructions = update(gcn_model, opt, sess, feas['adj_norm'],
        ...
        scipy.io.savemat('data/SavedRepresentation/Representation.mat', {'Representation': emb})
        scipy.io.savemat('data/SavedRepresentation/Representation_index.mat', {'Representation_index': Sub_idx})

        # scipy.io.savemat('data/test/35_2/attribute_reconstructions.mat', {'attribute_reconstructions': attribute_reconstructions})
        # scipy.io.savemat('data/test/35_2/structure_reconstructions.mat', {'structure_reconstructions': structure_reconstructions})
