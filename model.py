...
class GCNModelAE(Model):
    def __init__(self, placeholders, num_features, features_nonzero, **kwargs):
        ...
        self.input_dim = num_features  #8189
    ...
    def _build(self):
        self.hidden1 = GraphConvolutionSparse(input_dim=self.input_dim, #8189
                                              output_dim=FLAGS.hidden1, #64
                                              adj=self.adj,
        ...
        self.embeddings = GraphConvolution(input_dim=FLAGS.hidden1, #64
                                           output_dim=FLAGS.hidden2, #64
                                           adj=self.adj,
                                           act=tf.nn.relu,
                                           dropout=self.dropout,
        ...
        embe = scipy.io.loadmat('data/test/35_2/NoiseSubgraph.mat')
        embe = embe["NoiseSubgraph"]
        self.embeddings = tf.convert_to_tensor(embe, tf.float32)
